        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublishedYear = table.Column<int>(type: "INTEGER", nullable: false, defaultValue: 2025),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BooksBorrowers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BooksBorrowers_Books_BookID",
                        column: x => x.BookID,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BooksBorrowers_Borrowers_BorrowerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BooksBorrowers_BorrowerId",
                table: "BooksBorrowers",
                column: "BorrowerId");
